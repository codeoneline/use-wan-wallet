...
import { useWallet, UseWalletProvider } from 'use-wan-wallet'
...
- `reset()`: call this function to “disconnect” from the current provider. This will also clean the latest error value stored in `use-wan-wallet`'s state.
